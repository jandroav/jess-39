...
export const LevelMap: React.FC<Props> = ({
  ...
  const getGiftIcon = (
    ...
    switch (visualType) {
      case "footwear":
        return (
          <Footprints className="w-10 h-10" style={{ color: accentColor }} />
        );
      case "ring":
        return (
      ...
      case "michelin":
        return (
          <Utensils className="w-10 h-10" style={{ color: accentColor }} />
        );
      default:
    ...
    <div className="w-full max-w-7xl mx-auto px-6 py-8 flex flex-col justify-between min-h-[85vh] relative z-10">
      ...
      <div className="text-center space-y-4 mb-8">
        ...
        <p className="text-slate-300 text-xl md:text-2xl font-medium max-w-3xl mx-auto">
          Resuelve los retos para descubrir los páridis ocultos
        </p>
      </div>
          ...
          return (
            ...
            >
              ...
              <div className="my-6 space-y-3">
                ...
                >
                  {isUnlocked ? (
                    getGiftIcon(gift.visualType, gift.accentColor, isCompleted)
                  ) : (
                ...
                <div>
                  ...
                  <p className="text-sm font-medium text-slate-400 mt-1 line-clamp-2">
                    {isCompleted
                      ? gift.subtitle
                      : isUnlocked
                        ? gift.mysterySubtitle
                        : "Completa el nivel anterior para desbloquear este reto de salud."}
                  </p>
                </div>
              </div>
              ...
              <div className="pt-4 border-t border-slate-800/80 flex items-center justify-between">
                <span className="text-xs font-bold text-slate-400">
                  {gift.importanceRank === 3
                    ? "⭐ REGALO SUPREMO"
                    : `Nivel ${gift.importanceRank}`}
                </span>
